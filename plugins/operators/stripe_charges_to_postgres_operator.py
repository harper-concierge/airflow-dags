...
class StripeChargesToPostgresOperator(DagRunTaskCommsMixin, FlattenJsonDictMixin, BaseOperator):
    @apply_defaults
    def __init__(
        self,
        postgres_conn_id,
...
"""
    ...
    def execute(self, context):
        ...
        with engine.connect() as conn:
            ...
            self.log.info(
                f"Executing StripeChargesToPostgresOperator since last successful dagrun {last_successful_dagrun_ts}"
            )
